...
export default function Info () {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full px-8 md:px-16 flex-1 my-16 gap-16 md:gap-0 max-w-6xl mx-auto">
      ...
      >
        <img className="px-16 md:px-0 relative left-0 md:-left-24" src="/brushed-amarok.png" alt="Brushed Amarok" width={480} height={480} />
        <div className="flex flex-col gap-3 relative">
          <h3 className="text-xl sm:text-2xl font-bold text-white">
            Temporada 2024 - 2025
          </h3>
          <img src="/separator-half.png" alt="Separator" className="w-52 h-0.5 rotate-180" width={250} height={5} />
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <img src="/separator-half.png" alt="Separator" className="w-52 h-0.5" width={250} height={5} />
          <p className="text-sm sm:text-lg text-white">
        ...
        <img className="px-16 md:px-0 relative right-0 md:-right-24" src="/brushed-trickster.png" alt="Brushed Trickster" width={480} height={480} />
      </motion.div>
    </div>
  )
}